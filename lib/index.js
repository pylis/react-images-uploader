		...
		value: function handleImageChange(e) {
			...
			if (promise && promise.then) {
				promise.then(function (result) {
					_this4.props.setAdditionalProperties(result);
					_this4.continueHandleImageChange(filesList, onLoadEnd, result.postUrl, optimisticPreviews, multiple);
				});
			} else {
