...
var _desc, _value, _class; /* eslint-disable max-len */
...
var ImagesUploader = (_class = function (_Component) {
	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			if (this.props.image !== nextProps.image || !this.props.image && nextProps.image && nextProps.multiple === false) {
				this.setState({
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(files, url, onLoadEnd) {
				var imageFormData, keys, i, _i, response, multiple, _imagePreviewUrls2, err, _err;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								keys = Object.keys(this.props.additionalFormDataFields);
								...
								for (_i = 0; _i < files.length; _i++) {
									imageFormData.append(this.props.dataName, files[_i], files[_i].name);
								}
		...
		key: 'continueHandleImageChange',
		value: function continueHandleImageChange(filesList, onLoadEnd, url, optimisticPreviews, multiple) {
			var _this3 = this;
		...
		value: function handleImageChange(e) {
			...
			if (promise && promise.then) {
				promise.then(function () {
					_this4.continueHandleImageChange(filesList, onLoadEnd, _this4.props.url, optimisticPreviews, multiple);
				});
			} else {
